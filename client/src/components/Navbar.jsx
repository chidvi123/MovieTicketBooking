...
const Navbar = () => {
  ...
  return (
    ...
    justify-between px-6 md:px-16 lg:px-36 py-5'>
      ...
      {/* Responsive navbar: full-screen mobile menu and horizontal desktop menu with smooth animation */}
      ...
      >
        ...
        {/* Mobile-only close icon positioned at the top-right corner */}
      ...
      <div className='flex items-center gap-8'>
         ...
         {/* Search icon: visible on medium & large screens, hidden on mobile */}
        <SearchIcon className='max-md:hidden w-6 h-6 cursor-pointer'/>
        {
          !user ?(
            <button onClick={openSignIn} className='px-4 py-1 sm:px-7 bg-primary hover:bg-primary-dull transition 
      ...
      {/* Menu (hamburger) icon: visible on mobile, hidden on medium & large screens */}
